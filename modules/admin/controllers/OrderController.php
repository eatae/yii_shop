...
class OrderController extends Controller
{
    ...
    public function actionOrders()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Order::withCustomer(),
        ]);

        $orders = Order::withCustomer();
    ...
    public function actionShowOrder($id) {
        ...
        $orderItems = OrderItems::withProducts($order->id);
        ...
        return $this->render('show_order', compact('order', 'customer', 'orderItems', 'test'));
    }
